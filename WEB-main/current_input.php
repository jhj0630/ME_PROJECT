    ...
    <div class="main2">
        <div class="current_input">
            <div class="Input">
                ...
                <div class="InputData_canvans_left"><canvas id="currents_data_left" style="height: 200"></canvas></div>
                <div class="InputData_canvans_right"><canvas id="currents_data_right" style="height: 200"></canvas></div>
...
?>
    <script type="text/javascript">
        ...
        $( document ).ready( function() {
            ...
            c1.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top+55, left: hand_img_left+180});
                document.getElementById("hand_img").src = "leftpalm0.png";
                document.getElementById("body_img").src = "body1.png";
            });
            c2.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top+55, left: hand_img_left+195});
                document.getElementById("hand_img").src = "leftpalm0.png";
                document.getElementById("body_img").src = "body2.png";
            }); 
            c3.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top+55, left: hand_img_left+205});
                document.getElementById("hand_img").src = "leftpalm0.png";
            });  
            c4.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top+97, left: hand_img_left+222});
                document.getElementById("hand_img").src = "leftpalm0.png";
            });
            c5.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top+97, left: hand_img_left+232});
                document.getElementById("hand_img").src = "leftpalm0.png";
            }); 
            c6.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top+97, left: hand_img_left+242});
                document.getElementById("hand_img").src = "leftpalm0.png";
            });  
            
            c7.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top, left: hand_img_left});
                $('#hand_img').src = "left1.png";
            });
            c8.focus(function(){
                $("#dot").show();
                $('#dot').offset({top: hand_img_top, left: hand_img_left});
